...
export const i18n = createI18n({
  ...
  messages: {
    en: {
      ...
      initDeviceConfirm: 'Initialize the device will reinstall the 2 App, are you sure to initialize?',
      ...
      unFollow: 'UnFollow',
      userActions: 'Follow & UnFollow & Followers',
      ...
      leftDays: 'Left Days',
      usdtTip: 'Please use TRC20 network, transfer {amount} USDT to the address above!',
      licensed: 'Licensed',
      ...
      monthly: 'Monthly',
      yearly: 'Yearly',
      freeDescription: 'Free Trial, Limit 1 Phone, All Features Available, Requires Github Auth!',
      monthlyDescription: 'Buy 1 Month, Unlimited, All Features Available, Provide Manual Customer Service Support!',
      yearlyDescription: 'Buy 1 Year(50% Off), Unlimited, All Features Available, Provide Manual Customer Service Support!',
    ...
    'zh-CN': {
      ...
      allFeatures: '所有功能',
      freeLimited: '限制1台手机',
      freeDescription: '免费试用, 限制1台手机, 所有功能都可以使用, 需要Github认证!',
      monthlyDescription: '购买1个月, 无限制, 所有功能都可以使用, 提供人工客服技术支持!',
      yearlyDescription: '购买1年(5折), 无限制, 所有功能都可以使用, 提供人工客服技术支持!',
      monthly: '月度',
      yearly: '年度',
      ...
      licensedDays: '已授权天数',
      licensed: '已授权',
      usdtTip: '请使用TRC20网络,向上方地址转账 {amount} USDT!',
      closeOrder: '关闭订单',
      ...
      initDeviceConfirm: '初始化设备将重新安装2个App, 确定要初始化吗?',
