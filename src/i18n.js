...
export const i18n = createI18n({
  ...
  messages: {
    en: {
      ...
      trial: 'Trial',
      week: 'Week',
      trialDescription: 'The trial period is 3 days, during which you can use all functions for free. After the trial period ends, you need to purchase an official license. Each device can only use the trial version once.',
    ...
    'zh-CN': {
      ...
      trial: '试用',
      week: '周',
      trialDescription: '试用期为3天，试用期内可以免费使用所有功能，试用期结束后需要购买正式授权。每台设备只能试用一次。',
    },
    'ru': {
      ...
      week: 'Неделя',
      trialDescription: 'Пробная версия длится 3 дня, в течение которой вы можете использовать все функции бесплатно. После окончания пробного периода необходимо приобрести официальную лицензию. Каждое устройство может использовать пробную версию только один раз.',
