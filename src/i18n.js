...
export const i18n = createI18n({
  ...
  messages: {
    ...
    'ru': {
      ...
      openIpChecker: 'Открыть проверку IP',
      ...
      tasks: 'Задачи',
      packageNameSettings: 'Настройки имени пакета',
      registerSettings: 'Настройки регистрации',
      messageSettings: 'Настройки сообщений',
      ...
      tiktok: 'Tiktok',
      logout: 'Выйти',
      logoutConfirm: 'Вы уверены, что хотите выйти из всех аккаунтов на этом устройстве?',
      ...
      batchDM: 'Пакетные личные сообщения',
      usdttrc20: 'USDT-TRC20 оплата',
      usdtbep20: 'USDT-BEP20 оплата',
      loadSoundWaitTime: 'Время ожидания загрузки звука',
      batchDMTips: 'Если есть 1000 целевых аккаунтов и 100 аккаунтов в текущем выбранном устройстве, то каждый аккаунт отправит DM 10 целевым аккаунтам, задачи будут равномерно распределены между каждым выбранным аккаунтом',
