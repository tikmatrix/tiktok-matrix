...
export const i18n = createI18n({
  ...
  messages: {
    en: {
      ...
      startRegister: 'Start Register Task',
      fillProfile: 'Start Fill Profile Task',
      startLogin: 'Start Login Task',
      startTrain: 'Start Train Task',
      startPublish: 'Start Publish Task',
      whatsapp: 'Whatsapp',
      telegram: 'Telegram',
    ...
    'zh-CN': {
      ...
      startTrain: '开始养号任务',
      startLogin: '开始登录任务',
      fillProfile: '开始填写个人信息任务',
      startRegister: '开始注册任务',
      siteName: 'Tik Matrix',
      devices: '设备',
      accounts: '帐号',
      materials: '视频',
