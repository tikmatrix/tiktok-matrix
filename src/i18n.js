...
export const i18n = createI18n({
  ...
  messages: {
    en: {
      ...
      boostPostsWarning: 'The post boost feature allows you to control large-scale farm accounts to like, share, comment, and view target posts, quickly increasing the popularity and engagement of target posts.',
    ...
    'zh-CN': {
      ...
      boostPostsWarning: '提升帖子功能可以控制大规模农场账号对目标帖子进行点赞、分享、评论、观看等操作，可以快速为目标帖子增加热度。',
    ...
    'ru': {
      ...
      boostPostsWarning: 'Функция повышения постов позволяет управлять масштабными аккаунтами для лайков, репостов, комментариев и просмотров целевых постов, быстро увеличивая популярность и вовлеченность целевых постов.',
