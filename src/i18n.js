...
export const i18n = createI18n({
  ...
  messages: {
    en: {
      ...
      freeTrialActivated: 'Free Trial(+5 devices) Activated',
      ...
      leftDays: 'Left Days',
      usdtTip: 'Please ensure the network is TRC20, the amount is 99USDT or 599USDT!',
      licensed: 'Licensed',
    },
    'zh-CN': {
      licensed: '已授权',
      usdtTip: '请确保网络为TRC20，金额为99USDT或者599USDT!',
      closeOrder: '关闭订单',
      ...
      notAuthorized: '未授权',
      authorized: '已授权',
      freeTrialActivated: '免费试用(+5台手机)已激活',
      authorizeWithGithub: '通过 GitHub 授权',
