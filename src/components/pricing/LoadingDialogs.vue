<template>
    <div>
        ...
        <dialog ref="agreePolicyDialog" class="modal">
            <div class="modal-box max-w-md bg-linear-to-br from-warning/10 to-error/10 border border-warning/20">
                <form method="dialog">
        ...
        <dialog ref="createOrderLoadingDialog" class="modal">
            <div class="modal-box max-w-md bg-linear-to-br from-primary/10 to-secondary/10">
                <div class="text-center">
        ...
        <dialog ref="manageSubscriptionLoadingDialog" class="modal">
            <div class="modal-box max-w-md bg-linear-to-br from-success/10 to-info/10">
                <div class="text-center">
