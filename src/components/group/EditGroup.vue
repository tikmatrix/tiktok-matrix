<template>
  <div class="bg-base-100 flex flex-col items-start p-4">
    ...
    <details class="collapse collapse-arrow bg-base-200">
      <summary class="collapse-title text-xl font-medium">{{ $t('trainConfig') }}</summary>
      <div class="collapse-content">
        ...
        <div>
          ...
          <div class="grid grid-cols-4 w-full items-center gap-2 mb-2">
            ...
            <textarea class="textarea textarea-success w-full max-w-xl col-span-3 h-16"
    ...
    <details class="collapse collapse-arrow bg-base-200">
      <summary class="collapse-title text-xl font-medium">{{ $t('publishConfig') }}</summary>
      <div class="collapse-content">
        <div class="grid grid-cols-8 w-full items-center gap-2 mb-2">
