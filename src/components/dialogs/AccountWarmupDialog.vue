  ...
  <div class="bg-base-100 flex flex-col items-start p-4">
    ...
    <div class="flex w-full items-center gap-2 mb-2">
      ...
      <div class="flex items-center gap-4">
        <label class="flex items-center gap-1 cursor-pointer">
          <input type="radio" name="startOption" value="now" class="radio radio-sm radio-primary" v-model="startOption" />
          <span>{{ $t('startNow') }}</span>
        </label>
        <label class="flex items-center gap-1 cursor-pointer">
          <input type="radio" name="startOption" value="scheduled" class="radio radio-sm radio-primary" v-model="startOption" />
    ...
    <div>
      ...
      <div class="flex w-full items-center gap-2 mb-8">
        ...
        <VueSlider v-model="taskDurationInMinutes" :width="500" :min="10" :max="60" :marks="{10: '10'+$t('minute'),20: '20'+$t('minute'),30: '30'+$t('minute'),40: '40'+$t('minute'),50: '50'+$t('minute'),60: '60'+$t('minute')}" />
      </div>
      <div class="flex w-full items-center gap-2 mb-2">
      ...
      <div class="flex w-full items-center gap-2 mb-2">
        ...
        <div class="flex flex-col gap-2">
          <div class="flex flex-row items-center gap-2">
            ...
            <input type="checkbox" class="toggle toggle-accent" v-model="insert_emoji" title="😃, 😄, 😁, 😆, 😅, 😂, 🤣, 😊, 😇, 🙂, 🙃, 😉, 😋, 😛, 😝, 😜, 🤪, 😎, 🤩, 🥳, 😏, 🤗, 🤠, 😍, 😘, 😚, 😙, 😗, 🥰, 🤤, 😻, 😽, 💖, 💗, 💓, 💞, 💕, 💟, ❣️, 💌, 🌟, ✨, 💫, 🎉, 🎊, 🎁, 🎈, 🍾, 🥂, 🍻" />
          </div>
          <div class="flex flex-row items-center">
            <label class="font-bold">{{ $t('commentOrder') }}:</label>
            <div class="flex items-center">
              <label class="flex items-center gap-1 cursor-pointer">
                <input type="radio" name="commentOrder" value="random" class="radio radio-sm radio-primary" v-model="comment_order" />
                <span>{{ $t('random') }}</span>
              </label>
              <label class="flex items-center gap-1 cursor-pointer">
                <input type="radio" name="commentOrder" value="sequential" class="radio radio-sm radio-primary" v-model="comment_order" />
      ...
      <div class="flex w-full items-center gap-2 mb-2">
        ...
        <div class="flex flex-wrap gap-8">
          ...
          <div class="flex flex-col">
            ...
            <VueSlider v-model="floow_probable" :width="100" :min="0" :max="100" :marks="{0: '0%', 50: '50%', 100: '100%'}" />
          </div>
          ...
          <div class="flex flex-col">
            ...
            <VueSlider v-model="like_probable" :width="100" :min="0" :max="100" :marks="{0: '0%', 50: '50%', 100: '100%'}" />
          </div>
          ...
          <div class="flex flex-col">
            ...
            <VueSlider v-model="collect_probable" :width="100" :min="0" :max="100" :marks="{0: '0%', 50: '50%', 100: '100%'}" />
          </div>
          ...
          <div class="flex flex-col">
            ...
            <VueSlider v-model="comment_probable" :width="100" :min="0" :max="100" :marks="{0: '0%', 50: '50%', 100: '100%'}" />
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    async runScript() {
      await this.$emiter('run_now_by_account', { name: 'account_warmup', args: { 
