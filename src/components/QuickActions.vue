<template>
    ...
    <button class="btn btn-md btn-primary  ml-1 mb-1" @click="clearCache">
    ...
    <button class="btn btn-md btn-primary  ml-1 mb-1" :data-tip="$t('showTimeSetting')"
    ...
    <button class="btn btn-md btn-primary  ml-1 mb-1" :data-tip="$t('showLanguageSetting')"
    ...
    <button class="btn btn-md btn-primary  ml-1 mb-1" :data-tip="$t('showSimInfo')"
