<template>
  <div class="flex h-screen bg-gray-200 justify-center items-center w-full">
    <div class="bg-primary-content p-8 rounded-lg shadow-lg">
      ...
      <div class="mb-6">
        ...
        <input
          ...
          v-model="password" type="password" placeholder="password" @keyup.enter="auth" />
        <label class="text-error text-xs italic" v-if="error">{{ error }}</label>
      </div>
