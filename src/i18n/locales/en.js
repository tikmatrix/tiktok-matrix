export default {
  ...
  consumeOnceRetryLabel: 'Max retries per entry',
  consumeOnceRetryHelp: 'After an entry fails more than this number of times it will be discarded and no longer reused. Set to 0 to disable the retry cap.',
  ...
  datasetHasError: 'Has error',
  datasetHasErrorYes: 'Yes',
  datasetHasErrorNo: 'No',
  datasetLastError: 'Last error',
  datasetPageSizeLabel: 'Rows per page',
  datasetConsumedFlag: 'Consumed',
  datasetAvailableFlag: 'Available',
