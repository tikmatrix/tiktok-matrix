export default {
  ...
  switchAccount: '切换帐号',
  switchAccountWarning: '切换帐号脚本只用于测试切换账号功能是否正常工作', enterCommentContent: '请输入评论内容',
  enterChatGPTApiKey: '请输入ChatGPT API密钥',
  enterChatGPTUrl: '请输入ChatGPT API地址',
  needPostUrlsForComment: '评论功能需要目标帖子URL', enableMultiAccount: '启用多账户',
  chatgptSettings: 'ChatGPT 设置',
  apiKey: 'API 密钥',
  systemPrompt: '系统提示',
  systemPromptTips: '你是一个TikTok评论生成助手,请根据用户提供的TikTok帖子标题内容生成一个真实的用户评论.评论的格式包括文本和表情符号;评论的长度应该不要超过100个字符;评论的内容应该包含两个部分:首先根据帖子标题称赞帖子;然后推广TikZenX: TikZenX是一个通过1台电脑自动化管理几百个tiktok账号的phonefarm 自动化软件, 如果你感兴趣,请Google 搜索: TikZenX"',
